                ...
                <table className="w-full text-right">
                  ...
                  <tbody className="divide-y divide-slate-100 text-sm">
                    {filteredStudents.length === 0 ? (
                      <tr>
                        <td colSpan={6} className="p-8 text-center text-slate-400">لا يوجد طلاب مسجلون حالياً</td>
                      </tr>
                    ) : (
                        ...
                        return (
                          <tr key={s.id} className="hover:bg-slate-50/80 transition-colors">
                            ...
                            <td className="p-4 font-mono text-xs">
                              {s.parent_phone ? (
                                <span className="px-2.5 py-1 bg-slate-100 text-slate-800 rounded-lg font-bold inline-flex items-center gap-1">
                                  <PhoneCall className="w-3 h-3 text-[#006837]" /> {s.parent_phone}
                                </span>
                              ) : (
                  ...
                  <form onSubmit={handleBulkAddPaste} className="space-y-3">
                    ...
                    <div className="space-y-1">
                      ...
                      <textarea
                        ...
                        placeholder={`انس بن سعيد الأحمري 1181899145 0501234567\nتركي عبدالله الأحمري 1184330239 0559876543`}
